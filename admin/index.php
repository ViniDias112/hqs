		      ...
		      <li class="nav-item">
		        ...
		        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
		          <div class="bg-white py-2 collapse-inner rounded">
		            ...
		            <a class="collapse-item" href="cadastro/cidade">Cidades</a>
		            <a class="collapse-item" href="cadastro/cliente">Clientes</a>
		            <a class="collapse-item" href="cadastro/tipo">Tipo de Quadrinhos</a>
		            <a class="collapse-item" href="cadastro/editora">Editora de Quadrinhos</a>
		            <a class="collapse-item" href="cadastro/quadrinhos">Quadrinhos</a>
		    ...
		    <div id="content-wrapper" class="d-flex flex-column">
		      ...
		      <div id="content">
		          ...
		          <ul class="navbar-nav ml-auto">
		            ...
		            <li class="nav-item dropdown no-arrow">
		              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
		                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?=$_SESSION["hqs"]["nome"];?> </span>
		        ...
		        <div class="container-fluid">
					<?php
					//adicionar a programação para abrir a pagina desejada
						...
						if (isset( $_GET["parametro"])) {
						 ...
						 $pagina = "$pasta/$arquivo.php";
						  ...
						  //verificar se o id ou o 2• item existe
						 if (isset($p[2])) 
							$id = $p[2];
						}
		      ...
		      <footer class="sticky-footer bg-white">
		        <div class="container my-auto">
		          <div class="copyright text-center my-auto">
		            <span>Copyright &copy;  Desenvolvido por Vinicius Oliveira Dias</span>
		          </div>
		        </div>
		      </footer>
		    </div>
